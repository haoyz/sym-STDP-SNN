EXECUTABLE      :=train
SOURCES         :=src/train.cu src/model.cc src/reader/mnist/mnist.cc src/reader/cifar10/cifar10.cc src/gnuplot.cc src/drafting.cc src/evaluation.cc src/file_read.cc
SIM_CODE        :=model_CODE
